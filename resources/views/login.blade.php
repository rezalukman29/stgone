            ...
            <div class="box animation flipInX">
                <div class="box1">
                    <div class="text-center">
                        <img src="{{ asset('images/stg.png') }}" alt="logo" class="img-fluid mar"></div>
                    ...
                    <form action="{{ route('login') }}" class="omb_loginForm" autocomplete="off" method="POST">
                        ...
                        <div class="form-group {{ $errors->first('email', 'has-error') }}">
                            ...
                            <input type="text" class="form-control" name="email" placeholder="NIK"
                        ...
                        <input type="submit" class="btn btn-block btn-primary" style="background-color:#4E3524;" value="Log In">
                    ...
                    <div class="bg-transparent animation flipInX">
                     <a href="#" style="color:#4E3524;">Scandinavian Tobacco Group Indonesia, 2021</a> 
                    </div>
                </div>
