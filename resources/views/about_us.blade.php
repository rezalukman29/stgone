...
{!! Form::model($user, ['url' => URL::to('about_us'), 'method' => 'put', 'class' => 'form-horizontal','enctype'=>"multipart/form-data"]) !!}
...
<div class="container">
    ...
    <div class="row my-3">
        ...
        <div class="col-md-7 col-sm-12  col-md-12 col-lg-8 wow bounceInLeft" data-wow-duration="5s">
            ...
            <li class="nav-item"><a class="nav-link"> <input type="text" placeholder=" " name="full_name" id="full_name"
                                               class="form-control"
                                               value="{!! old('full_name',$user->full_name) !!}"></a>
                        </li>
            <p>
