...
@section('content')
    ...
    <h3 class="border-danger"><span class="heading_border bg-danger">Profile</span></h3>
        ...
        <div class="col-md-12 col-lg-6 col-12 wow bounceInRight" data-wow-duration="1.5s">
            ...
            <ul style="padding: 0 0 0 10px;">
                ...
                <li><a class=" btn btn-primary" href="#"><span class="text-white"><i class="livicon"
                 ...
                 <input type="text" name="cekperiod" id="cekperiod" value="2021-04" class="form-control" >
        ...
        <div class="text-center col-12 wow flash my-3" data-wow-duration="3s">
            ...
            {!! Form::select('period', $period , null,['class' => 'form-control', 'period' => 'period', 'placeholder' => 'Please Select One...']) !!}
            <select name="listperiod" id="listperiod">
...
<div class="row my-3">
                      <div class="col-lg-12  wow fadeInDown " data-wow-duration="3s" data-wow-delay="0.5s">
                        <div class="card filterable">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered width100" id="table5" >
                                    <thead>
                                    <tr class="filters">
                                    <th>id</th>
                                    <th>NIK</th>
...
//            });
            ...
            var periodValue = document.getElementById("cekperiod").value;

            var table3 = $('#table3').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: '{!! URL::to('daily_absensi/selectData') !!}',
                    data: function (d) {
                        d.professionSelect = nameValue;
                        d.periodSelect = periodValue;
