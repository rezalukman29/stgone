<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! (Request::is('admin/datatables') || Request::is('admin/editable_datatables')  || Request::is('admin/sample') || Request::is('admin/dropzone') || Request::is('admin/multiple_upload') || Request::is('admin/custom_datatables')|| Request::is('admin/selectfilter') ? 'class="active"' : '' ) !!}>
        <a href="#">
        ...
        <ul class="sub-menu">
            ...
            <li {!! (Request::is('admin/selectfilter') ? 'class="active"' : '' ) !!}>
                ...
                <li {!! (Request::is('admin/sample') ? 'class="active"' : '' ) !!}>
                <a href="{{ URL::to('admin/sample') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Sample Tabel
                </a>
            </li>
