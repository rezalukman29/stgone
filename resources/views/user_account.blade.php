                ...
                <div class="col-lg-10 col-12">
                    ...
                    <div class="position-center">
                        ...
                        <i class="livicon" data-name="user" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                            ...
                            <div class="form-group {{ $errors->first('last_name', 'has-error') }}">
                                <div class="row">
                                    ...
                                    <span class="help-block">{{ $errors->first('nik', ':message') }}</span>
                                </div>
                                </div>
                            </div>
                            <div class="form-group {{ $errors->first('department', 'has-error') }}">
                                <div class="row">
                                    ...
                                    <div class="input-group input-group-append">
                                        ...
                                        <input type="label" placeholder=" " name="department" id="department" 
                                               class="form-control"
                                               value="{!! old('department',$user->department) !!}"></div>
                            ...
                            <div class="form-group {{ $errors->first('position', 'has-error') }}">
                                <div class="row">
                                    ...
                                    <div class="input-group input-group-append">
                                        ...
                                        <input type="label" placeholder=" " name="position" id="position" 
                                               class="form-control"
                                               value="{!! old('position',$user->position) !!}"></div>
                        ...
                        <i class="livicon" data-name="mail" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                        ...
                                        <input type="text" placeholder=" " id="surel" name="surel" class="form-control"
                                               value="{!! old('surel',$user->surel) !!}"></div>
                                    <span class="help-block">{{ $errors->first('surel', ':message') }}</span>
                                </div>
