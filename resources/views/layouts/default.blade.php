...
<body>
    ...
    <header>
        <!--Icon Section Start-->
        <div class="icon-section" style="background-color:#4E3524;">
            <div class="container" >
                <div class="row" >
        ...
        <div class="container indexpage">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
                <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('images/stg.png') }}"
                        alt="logo" style="width:70px;"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto  margin_right">
                        ...
                        <li
                            class=" nav-item dropdown  {!! (Request::is('daily_absensi') || Request::is('advanced_features') || Request::is('grid') ? 'active' : '') !!}">
                            <a href="#" aria-expanded="false" class="nav-link"> Absensi</a>
                            <ul class="dropdown-menu" role="menu">
                            <li class="nav-item {{ (Request::is('daily_absensi') ? 'active' : '') }}"><a
                            href="{!! route('daily_absensi') !!}" class="nav-link">Daily Absensi</a>
                            </li>
                        ...
                        <li
                            class=" nav-item dropdown  {!! (Request::is('history_cuti') || Request::is('advanced_features') || Request::is('grid') ? 'active' : '') !!}">
                            <a href="#" aria-expanded="false" class="nav-link"> Cuti</a>
                            <ul class="dropdown-menu" role="menu">
                            <li class="nav-item {{ (Request::is('history_cuti') ? 'active' : '') }}"><a
                                href="{!! route('history_cuti') !!}" class="nav-link">History Cuti</a>
                            </li>
                        ...
                        <li
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="nav-item {{ (Request::is('about_us') ? 'active' : '') }}"><a
                                href="{{ URL::to('about_us') }}" class="dropdown-item">About Us</a>
                                 </li>
