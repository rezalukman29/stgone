...
@section('top')
<!--Carousel Start -->
<div id="owl-demo" class="owl-carousel owl-theme" style="position:center;">
    <div class="item img-fluid"><img src="{{ asset('images/stgslider1.png') }}" alt="slider-image" />
    </div>
    <div class="item img-fluid"><img src="{{ asset('images/stgslider2.png') }}" alt="slider-image">
    </div>
    <div class="item img-fluid"><img src="{{ asset('images/stgslider3.png') }}" alt="slider-image">
    </div>
</div>
<!-- //Carousel End -->
@stop
