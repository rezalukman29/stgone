...
Route::group(
    ...
    **************************/
       ...
       /*routes for blog departemen*/
        //    Route::group(
        //     ['prefix' => 'department'],
        //     function () {
        //         Route::get('{department}/delete', 'DepartmentController@destroy')->name('department.delete');
        //         Route::get('{department}/confirm-delete', 'DepartmentController@getModalDelete')->name('department.confirm-delete');
        //         Route::get('{department}/restore', 'DepartmentController@getRestore')->name('department.restore');
        //     }
        // );
        ...
        Route::get('custom_datatables', 'CustomDataTablesController_absent@index')->name('index');
        ...
        Route::get('custom_datatables/selectDataCuti', 'CustomDataTablesController_suratcuti@selectDataCuti')->name('custom_datatables.selectDataCuti');
        Route::get('custom_datatables/selectData_absent', 'CustomDataTablesController_absent@selectData_absent')->name('custom_datatables.selectData_absent');
...
Route::group(
    ...
    function () {
        ...
        Route::get('daily_absensi', 'FrontEndController@daily_absensi')->name('daily_absensi');
...
Route::get('history_cuti', ['as' => 'history_cuti', 'uses' => 'Admin\CustomDataTablesController_front@index']);
Route::get('history_cuti/selectData', 'Admin\CustomDataTablesController_front@selectData')->name('history_cuti.selectData');
Route::get('history_cuti', 'FrontEndController@history_cuti')->name('history_cuti');



Route::get('daily_absensi', 'Admin\FrontDataAbsent@index')->name('index');
Route::get('daily_absensi', ['as' => 'daily_absensi', 'uses' => 'Admin\FrontDataAbsent@index']);
Route::get('daily_absensi/selectData', 'Admin\FrontDataAbsent@selectData')->name('daily_absensi.selectData');
Route::get('daily_absensi', 'FrontEndController@daily_absensi')->name('daily_absensi');
