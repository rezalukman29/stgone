...
Route::group(
    ...
    **************************/
       ...
       /*routes for blog departemen*/
        ...
        Route::get('sample', 'DatatableController@index')->name('index');
        Route::get('sample/totalData', 'DatatableController@totalData')->name('sample.totalData');
...
Route::get('daily_absensi/totalData', 'Admin\FrontDataAbsent@totalData')->name('daily_absensi.totalData');

Route::get('/', ['as' => 'home', 'uses' => 'Admin\Menutop@index']);
