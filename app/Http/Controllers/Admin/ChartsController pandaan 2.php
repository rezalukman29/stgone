...
class ChartsController extends Controller
{
    public function index()
    {
        ...
        $line->dataset(Padang Sederhana, 'line', [32500, 22500])->options(
            [
            'color' => '#418bca'
            ]
        );
        $line->dataset('Warkop Pak Nur', 'line', [4000, 3000])->options(
            [
            'color' => '#F89A14'
            ]
        );
        $line->dataset('Rawon Anda', 'line', [18000, 6000])->options(
            [
            'color' => '#67c5df'
            ]
        );
        $line->dataset('Es Kelapa', 'line', [3000, 2500])->options(
            [
            'color' => '#d90fc5'
            ]
        );
        $line->dataset('Mie Ayam Rahima', 'line', [18000, 15000])->options(
            [
            'color' => '#22e31b'
            ]
        );
        $line->dataset('Ayam Lodho', 'line', [4000, 2000])->options(
            [
            'color' => '#000000'
            ]
        );
