...
use App\Models\AsetTaking\ResumeAset;
use App\Http\Controllers\AppBaseController as InfyOmBaseController;

class ResumeAsetController extends InfyOmBaseController {
    ...
    //   }
      ...
      public function getAllResumeAset(){
        return ResumeAset::all();
    }


    public function getAllResumeAsetPending($query){
      $query = ResumeAset::->whereNull('remarks');
      }
  }
