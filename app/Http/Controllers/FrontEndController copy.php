...
class FrontEndController extends JoshController
{
    ...
    public function index()
    {
        ...
        return view('daily_absensi', compact('professions','user', 'countries'));
    }
    ...
    public function about_us()
    {
        $user = Sentinel::getUser();
        $countries = Country::all()->pluck('name', 'sortname')->toArray();
        return view('about_us', compact('user', 'countries'));
    }
    ...
    public function history_cuti()
    {
        $user = Sentinel::getUser();
        $countries = Country::all()->pluck('name', 'sortname')->toArray();
        return view('history_cuti', compact('user', 'countries'));
    }
